                ...
                <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                    ...
                    <li class="nav-item">
                        <a rel="nofollow" href="#" class="nav-link dropdown-item">
                            ...
                            <img class="profile-photo sm mr-1" src="{{ asset('../../'.tenantPath().'/uploads/profile_photos/')}}/{{auth()->user()->profile_photo}}">
                            @else
                            <img class="profile-photo sm mr-1" src="{{ asset('../../'.tenantPath().'/uploads/profile_photos/avatar.jpg')}}">
                            @endif
